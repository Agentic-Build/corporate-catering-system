...
<script lang="ts">
  ...
  // Stroke width — 2.2 for plus/minus (heavier), 2 for check, 1.8 otherwise.
  const strokeWidth = $derived(
    name === "plus" || name === "minus" ? "2.2" : name === "check" ? "2" : "1.8",
  );
</script>
...
>
  ...
  {:else if name === "wallet"}
    <path d="M3 7a2 2 0 0 1 2-2h13l3 3v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
